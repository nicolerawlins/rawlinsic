      ...
      <section style={{ padding: "180px 48px 100px", maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ color: "#fff", fontSize: 15, fontWeight: 500, lineHeight: 1.9, display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <div>
            ...
            <p style={{ marginTop: 12 }}>To exercise any of these rights, please contact us at <a href="mailto:info@rawlinsic.com" style={{ color: "#fff" }}>info@rawlinsic.com</a>. We will respond to your request within a reasonable timeframe and in accordance with applicable law.</p>
          </div>
