...
const landscapePaths = [
  ...
  { from: 'urban-air-taxi', to: 'residential', color: '#9aa6b4', type: 'air-taxi' },
  { from: 'urban-air-taxi', to: 'rural', color: '#9aa6b4', type: 'air-taxi' },
  { from: 'residential', to: 'rural', color: '#9aa6b4', type: 'air-taxi' },
  { from: 'residential', to: 'city-center', color: '#9aa6b4', type: 'air-taxi' },
  { from: 'urban-air-taxi', to: 'city-center', color: '#9aa6b4', type: 'air-taxi' },
                ...
                <svg viewBox="0 0 1000 660" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', width: '110%', height: 'auto', marginLeft: '-5%' }}>
                  <defs>
                    <linearGradient id="lsGoldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                      ...
                      <stop offset="50%" stopColor="#e7ecf1" />
                      <stop offset="100%" stopColor="#9aa6b4" />
                    </linearGradient>
                    <radialGradient id="lsNodeGlow" cx="50%" cy="50%" r="50%">
                      <stop offset="0%" stopColor="#9aa6b4" stopOpacity="0.4" />
                      <stop offset="100%" stopColor="#9aa6b4" stopOpacity="0" />
                    </radialGradient>
                    <filter id="lsGlow" x="-50%" y="-50%" width="200%" height="200%">
                      <feGaussianBlur in="SourceAlpha" stdDeviation="6" result="blur" />
                      <feFlood floodColor="#9aa6b4" floodOpacity="0.5" result="color" />
                  ...
                  <g opacity="0.04">
                    {Array.from({ length: 21 }, (_, i) => (
                      <React.Fragment key={`lsg-${i}`}>
                        <line x1={i * 50} y1="0" x2={i * 50} y2="600" stroke="#9aa6b4" strokeWidth="0.5" />
                        <line x1="0" y1={i * 30} x2="1000" y2={i * 30} stroke="#9aa6b4" strokeWidth="0.5" />
                      </React.Fragment>
                    ))}
                  </g>
                  ...
                  <g opacity={hoveredLs === 'urban-air-taxi' ? 1 : 0.85} style={{ transition: 'opacity 0.3s' }}>
                    <g transform="translate(93.49,225.83)">
                      ...
                      <circle cx="0" cy="-7" r="4" fill="#9aa6b4" />
                  ...
                  <g opacity={hoveredLs === 'package-delivery' ? 1 : 0.85} style={{ transition: 'opacity 0.3s' }}>
                    ...
                    <g transform="translate(121.49,402.03)">
                      ...
                      <line x1="9" y1="7" x2="14" y2="16" stroke="#aaa6a0" strokeWidth="1.5" />
                      <line x1="0" y1="7" x2="0" y2="18" stroke="#9aa6b4" strokeWidth="1" />
                      <rect x="-9" y="18" width="18" height="16" rx="2" fill="#9aa6b4" stroke="#dab84c" strokeWidth="1" />
                  ...
                  <g opacity={hoveredLs === 'city-center' ? 1 : 0.85} style={{ transition: 'opacity 0.3s' }}>
                    ...
                    <rect x="717.49" y="430.09" width="6" height="6" fill="#9aa6b4" />
                    <rect x="725.49" y="430.09" width="6" height="6" fill="#9aa6b4" />
                    <rect x="717.49" y="442.09" width="6" height="6" fill="#9aa6b4" />
                  ...
                  {landscapePaths.map((fp, i) => {
                    ...
                    const hlColor = hl ? (fp.type === 'air-taxi' ? '#e7ecf1' : fp.type === 'medical' ? '#e8585a' : '#b8976a') : fp.color;
                    return (
                  ...
                  {[0, 1, 5, 7, 10].map(idx => {
                    ...
                    if (!fp) return null;
                    const c = fp.type === 'medical' ? '#d4443b' : fp.type === 'delivery' ? '#8b6f47' : '#9aa6b4';
                    return (
                  ...
                  {landscapeNodes.map((node, ni) => {
                    ...
                    const sc = isMed && hl ? '#d4443b' : hl ? '#e7ecf1' : 'rgba(201,168,76,0.4)';
                    ...
                    return (
                      ...
                      >
                        {/* Pulse ring */}
                        <circle cx={nx} cy={ny} r={32} fill="none" stroke={isMed ? '#d4443b' : '#9aa6b4'} strokeWidth="0.8" className="ls-node-pulse" style={{ animationDelay: `${ni * 0.5}s` }} />
                        {/* Glow */}
                ...
                <svg className="eco-svg" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <filter id="goldGlow" x="-50%" y="-50%" width="200%" height="200%">
                      <feGaussianBlur in="SourceAlpha" stdDeviation="6" result="blur" />
                      <feFlood floodColor="#9aa6b4" floodOpacity="0.4" result="color" />
                      <feComposite in="color" in2="blur" operator="in" result="shadow" />
                      <feMerge><feMergeNode in="shadow" /><feMergeNode in="SourceGraphic" /></feMerge>
                    </filter>
                    <filter id="goldGlowStrong" x="-50%" y="-50%" width="200%" height="200%">
                      <feGaussianBlur in="SourceAlpha" stdDeviation="12" result="blur" />
                      <feFlood floodColor="#9aa6b4" floodOpacity="0.6" result="color" />
                      <feComposite in="color" in2="blur" operator="in" result="shadow" />
                      <feMerge><feMergeNode in="shadow" /><feMergeNode in="SourceGraphic" /></feMerge>
                    </filter>
                    <linearGradient id="lineGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="#9aa6b4" stopOpacity="0.1" />
                      <stop offset="50%" stopColor="#9aa6b4" stopOpacity="0.5" />
                      <stop offset="100%" stopColor="#9aa6b4" stopOpacity="0.1" />
                    </linearGradient>
                    <radialGradient id="centerGrad" cx="50%" cy="50%" r="50%">
                      <stop offset="0%" stopColor="#9aa6b4" stopOpacity="0.25" />
                      <stop offset="60%" stopColor="#9aa6b4" stopOpacity="0.08" />
                      <stop offset="100%" stopColor="#9aa6b4" stopOpacity="0" />
                    </radialGradient>
                  ...
                  <g opacity="0.04">
                    {Array.from({ length: 17 }, (_, i) => (
                      <React.Fragment key={`grid-${i}`}>
                        <line x1={i * 50} y1="0" x2={i * 50} y2="800" stroke="#9aa6b4" strokeWidth="0.5" />
                        <line x1="0" y1={i * 50} x2="800" y2={i * 50} stroke="#9aa6b4" strokeWidth="0.5" />
                      </React.Fragment>
                    ))}
                  </g>

                  {/* Orbital rings */}
                  <circle cx="400" cy="400" r="200" fill="none" stroke="#9aa6b4" strokeWidth="0.5" className="eco-orbit-ring" />
                  <circle cx="400" cy="400" r="270" fill="none" stroke="#9aa6b4" strokeWidth="0.5" className="eco-orbit-ring-2" />
                  <circle cx="400" cy="400" r="340" fill="none" stroke="#9aa6b4" strokeWidth="0.3" className="eco-orbit-ring-3" />
                  ...
                  {ecosystemNodes.map((node) => {
                    ...
                    return (
                      <line key={`line-${node.id}`} x1="400" y1="400" x2={nx} y2={ny} stroke="#9aa6b4" strokeWidth={isActive ? 2 : 1} className={isActive ? "eco-connection-active" : "eco-connection"} opacity={isActive ? 0.8 : 0.2} />
                    );
                  })}
                  ...
                  {ecosystemNodes.map((node, i) => {
                    ...
                    return (
                      <line key={`cross-${i}`} x1={400 + Math.cos(rad1) * 280} y1={400 + Math.sin(rad1) * 280} x2={400 + Math.cos(rad2) * 280} y2={400 + Math.sin(rad2) * 280} stroke="#9aa6b4" strokeWidth="0.5" className="eco-connection" opacity="0.08" />
                    );
                  })}

                  {/* Center glow */}
                  <circle cx="400" cy="400" r="100" fill="url(#centerGrad)" />
                  <circle cx="400" cy="400" r="68" fill="none" stroke="#9aa6b4" strokeWidth="0.8" className="eco-center-pulse" opacity="0.2" />
                  ...
                  {/* Particles — outbound */}
                  {ecosystemNodes.map((node, i) => (
                    <circle key={`particle-out-${i}`} r="2" fill="#9aa6b4" className="eco-data-particle" style={{ animationDelay: `${i * 0.5}s` }}>
                      <animateMotion dur={`${3 + i * 0.3}s`} repeatCount="indefinite"><mpath href={`#path-out-${i}`} /></animateMotion>
                    </circle>
                  ))}
                  {/* Particles — inbound */}
                  {ecosystemNodes.map((node, i) => (
                    <circle key={`particle-in-${i}`} r="2" fill="#9aa6b4" className="eco-data-particle" style={{ animationDelay: `${i * 0.5 + 1.5}s` }}>
